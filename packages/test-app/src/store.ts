import { applyMiddleware, Action, compose, createStore, Store, StoreEnhancer } from 'redux';
...
const store: Store<RootState, Action> = enhancedCreateStore(createReducer(history), undefined, enhancer);
